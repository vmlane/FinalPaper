...
\subsection{Pipeline}
   ...
   % \begin{figure}[b]
   %    \centering
   %    \includegraphics[scale=0.4]{figures/6_832blockdiagram.jpg}
   %    \caption{The ATRIAS biped.}
   %    \label{pipeline}
   % \end{figure}
...
\bibitem{c2} S. Kuindersma, F. Permenter, and R. Tedrake, ÒAn efficiently solvable quadratic program for stabilizing dynamic locomotion,Ó in Robotics and Automation, 2013. ICRA ’13. IEEE International Conference on, 2013.

%\bibitem{c3} G. O. Young, ÒSynthetic structure of industrial plastics (Book style with paper title and editor),Ó  in Plastics, 2nd ed. vol. 3, J. Peters, Ed.  New York: McGraw-Hill, 1964, pp. 15Ð64.
