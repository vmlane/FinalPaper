...
$$
\begin{array} {lcl} \dot{\mathbf{x}} & = & \mathbf{Ax} + \mathbf{Bu} \\ & = & \left[ \begin{array}{cc} 0 & \mathbf{I}  \\ 0 & 0 \end{array} \right]\] \mathbf{x} + \left[ \begin{array}{cc} 0  \\ \mathbf{I} \end{array} \right]\] \mathbf{u} \end{array}
$$

$$
\begin{array} {lcl} \mathbf{y} & = & \mathbf{Cx} - b(\mathbf{x},\dot{\mathbf{x}})\mathbf{u} \\ & = & \left[ \begin{array}{cc} \mathbf{I} & 0 \end{array} \right]\] \mathbf{x} - \frac{z_{com}}{\ddot z_{com} + g} \mathbf{Iu} \end{array}
$$
