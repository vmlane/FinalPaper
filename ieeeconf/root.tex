...
The first term of the objective function is determined from the LQR cost-to-go described in the previous section. The second term penalizes errors in the commanded torques. Finally, the third term is related to the friction cone of the contact points of the feet. Minimizing this objective function subject to the constraints gives the optimal torques at each time step. 
